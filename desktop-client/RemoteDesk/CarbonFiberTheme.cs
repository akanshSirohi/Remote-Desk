...
namespace CS_ClassLibraryTester
{
    ...
    class CarbonFiberTheme : ThemeContainer154
    {
        ...
        protected override void PaintHook()
        {
            ...
            if (_ShowIcon == false)
            {
                ...
                // Text Shadow
                G.DrawString(Text, Font, new SolidBrush(Color.FromArgb(28, 229, 28)), new Point(8, 8));
            }
            else {
                ...
                // Text Shadow
                G.DrawString(Text, Font, new SolidBrush(Color.FromArgb(28, 229, 28)), new Point(28, 8));
            }
    ...
    class CarbonFiberLabel : ThemeControl154
    {
        ...
        protected override void PaintHook()
        {
            ...
            // Text Shadow
            G.DrawString(Text, Font, new SolidBrush(Color.FromArgb(28, 229, 28)), new Point(1, 1));
        }
        #endregion
    }
    ...
    class CarbonFiberButton : ThemeControl154
    {
        ...
        protected override void PaintHook()
        {
            ...
            G.DrawString(Text, Font, new SolidBrush(Color.FromArgb(28, 229, 28)), new Rectangle(0, 0, Width - 1, Height - 1), new StringFormat
            {
                Alignment = StringAlignment.Center,
                LineAlignment = StringAlignment.Center
            });
    ...
    class CarbonFiberListBox : ListBox
    {
        ...
        protected override void OnDrawItem(DrawItemEventArgs e)
        {
            ...
            try
            {
                ...
                G.DrawString(" " + Items[e.Index].ToString(), Font, new SolidBrush(Color.FromArgb(28, 229, 28)), e.Bounds.X, e.Bounds.Y + 1);
            }
            catch
            {
            }
    ...
    class CarbonFiberGroupBox : ThemeContainer154
    {
        ...
        protected override void PaintHook()
        {
            ...
            //G.DrawString(Text, Font, New SolidBrush(Color.FromArgb(28, 229, 28)), New Point(8, 6))

            DrawText(new SolidBrush(Color.Black), HorizontalAlignment.Center, 1, 1);
            DrawText(new SolidBrush(Color.FromArgb(28, 229, 28)), HorizontalAlignment.Center, 2, 2);
    ...
    class CarbonFiberCheckbox : ThemeControl154
    {
        ...
        protected override void PaintHook()
        {
            ...
            if (_Checked)
            {
                ...
                G.DrawString("a", new Font("Marlett", 12), new SolidBrush(Color.FromArgb(28, 229, 28)), new Point(-2, 0));
            }
            else {
                // Do Nothing ^^
            }
            ...
            G.DrawString(Text, Font, new SolidBrush(Color.FromArgb(28, 229, 28)), 18, 1);
        }
    ...
    class CarbonFiberTabControl : TabControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (!(SelectedIndex == -1))
            {
                ...
                G.DrawString(TabPages[SelectedIndex].Text, Font, new SolidBrush(Color.FromArgb(28, 229, 28)), x1, new StringFormat
                {
                    LineAlignment = StringAlignment.Center,
                    Alignment = StringAlignment.Center
                });
    ...
    class CarbonFiberRadioButton : ThemeControl154
    {
        ...
        protected override void PaintHook()
        {
            ...
            if (_Checked)
            {
                G.FillEllipse(new SolidBrush(Color.FromArgb(28, 229, 28)), 5, 5, 6, 6);
            }
            else {
            }
    ...
    class CarbonFiberControlButton : ThemeControl154
    {
        ...
        protected override void PaintHook()
        {
            ...
            if (_StateMinimize == true)
            {
                G.DrawString("0", new Font("Marlett", 8), new SolidBrush(Color.FromArgb(28, 229, 28)), new Point(6, 4));
                _StateClose = false;
                // false
                _StateMaximize = false;
            }
            if (_StateClose == true)
            {
                G.DrawString("r", new Font("Marlett", 8), new SolidBrush(Color.FromArgb(28, 229, 28)), new Point(6, 4));
                _StateMinimize = false;
                _StateMaximize = false;
            }
            ...
            {
                if (FindForm().WindowState != FormWindowState.Maximized)
                    G.DrawString("1", new Font("Marlett", 8), new SolidBrush(Color.FromArgb(28, 229, 28)), new Point(6, 4));
                else
                    G.DrawString("2", new Font("Marlett", 8), new SolidBrush(Color.FromArgb(28, 229, 28)), new Point(6, 4));
                _StateClose = false;
                // false
                _StateMinimize = false;
            }
    ...
    class CarbonFiberTextBox : ThemeControl154
    {
        ...
        public CarbonFiberTextBox()
        {
            ...
            Base.ForeColor = Color.FromArgb(28, 229, 28);
            if (_Multiline)
            {
                Base.Height = Height - 11;
            }
            ...
            using (Bitmap B = new Bitmap(Width, Height))
            {
                Graphics G = Graphics.FromImage(B);
                    ...
                    if (_ShowPercentage)
                    {
                        ...
                        G.DrawString(Convert.ToString(string.Concat(Progress, "%")), Font, new SolidBrush(Color.FromArgb(28, 229, 28)), new Rectangle(0, 1, Width - 1, Height - 1), new StringFormat
                        {
                            Alignment = StringAlignment.Center,
                            LineAlignment = StringAlignment.Center
                        });
